      ...
      <div className={styles.container}>
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerCol}>
            ...
            <a className={styles.footerLink} href="#tutors">Find Tutors</a>
          ...
          <div className={styles.footerCol}>
            ...
            <Link className={styles.footerLink} href="/privacy">Privacy Policy</Link>
            <Link className={styles.footerLink} href="/terms">Terms of Service</Link>
            <a className={styles.footerLink} href="#trust">Trust & Safety</a>
          </div>
        </div>
